...
export const Hero = () => {
  return (
    <div className="relative flex flex-col items-center">
      ...
      <div className="group lg:w-[990px] w-[350px] md:w-[600px] lg:h-[166px] h-[80px] md:h-[120px] bg-white hover:cursor-pointer font-figtree lg:rounded-[27px] rounded-2xl z-[999] flex flex-row lg:px-[150px]  px-[50px] justify-between items-center  mt-20 lg:mt-0">
